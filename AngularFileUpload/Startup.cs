...
using AutoMapper;
using AngularFileUpload.Mapping;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentityServer()
                .AddApiAuthorization<ApplicationUser, ApplicationDbContext>(options =>
                {
                    ...
                    apiResource.UserClaims = new[] { ClaimTypes.Name, ClaimTypes.Email, ClaimTypes.NameIdentifier };
                });
            ...
            //services.AddDbContext<AppDbContext>(options => options.UseInMemoryDatabase(databaseName: "UploaderDb"));
